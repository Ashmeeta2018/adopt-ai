    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          <Text style={styles.date}>WED · MAY 22</Text>
        ...
        <Pressable onPress={() => router.push('/(portal)/reports')}>
...
const styles = StyleSheet.create({
  ...
  heroNumber: { fontFamily: 'Sora', fontSize: 64, color: '#fff8f0', fontWeight: '600' },
  heroSub: { fontFamily: 'Inter', fontSize: 13, color: 'rgba(255,248,240,0.85)' },
  sectionTitle: {
    marginTop: 24,
    marginBottom: 12,
    fontFamily: 'Sora',
  ...
  agentDescription: { fontFamily: 'Inter', fontSize: 12, color: 'rgba(61,26,15,0.65)' },
  agentMetrics: {
    marginTop: 4,
    fontFamily: 'IBMPlexMono',
    fontSize: 11,
  ...
  chevron: { fontSize: 24, color: 'rgba(61,26,15,0.4)' },
});
